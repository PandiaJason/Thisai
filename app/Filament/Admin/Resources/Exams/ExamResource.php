...
use App\Filament\Admin\Resources\Exams\RelationManagers;
                ...
                \Filament\Schemas\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\Select::make('created_by')
                            ->relationship('creator', 'name', fn ($query) => $query->whereIn('role', [UserRole::FACULTY->value, UserRole::SUPER_ADMIN->value]))
                            ->default(fn () => auth()->id())
                            ->required(),
