...
<div class="w-full max-w-sm">
    <div class="text-center mb-8 flex flex-col items-center">
        ...
        <p class="text-slate-600 dark:text-slate-400 text-sm mt-1">Choose a strong password for your account</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg px-4 py-2 text-sm text-slate-500 dark:text-slate-400">
                {{ $email }}
            </div>
        </div>
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Confirm Password</label>
